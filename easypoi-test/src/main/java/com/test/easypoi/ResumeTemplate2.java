...
public class ResumeTemplate2 {
	...
	private final static String bootPath = "/Users/lvdawei/idea/easypoi-test/src/main/java";
	...
	public static void main(String[] args) {
        ...
        try {
            XWPFDocument doc = WordExportUtil.exportWord07(
                    "/Users/lvdawei/idea/easypoi-test/src/main/java/com/test/easypoi/doc/resume_template.docx", map);
            FileOutputStream fos = new FileOutputStream("/Users/lvdawei/idea/easypoi-test/src/main/java/com/test/easypoi/doc/resume_"+name+".docx");
            doc.write(fos);
            fos.close();
